    ...
    return tn.HyperparameterNode(
        ...
        tn.SequentialNode(
            ...
            [tn.HyperparameterNode(
                ...
                tn.SequentialNode(
                    "conv_group_1_seq",
                    [tl.Conv2DNode("conv1_1"),
                     tn.ReLUNode("relu1_1"),
                     tl.Conv2DNode("conv1_2"),
                     tn.ReLUNode("relu1_2")]),
                num_filters=64),
             ...
             tn.HyperparameterNode(
                ...
                tn.SequentialNode(
                    "conv_group_2_seq",
                    [tl.Conv2DNode("conv2_1"),
                     tn.ReLUNode("relu2_1"),
                     tl.Conv2DNode("conv2_2"),
                     tn.ReLUNode("relu2_2")]),
                 num_filters=128),
             ...
             tn.HyperparameterNode(
                ...
                tn.SequentialNode(
                    "conv_group_3_seq",
                    [tl.Conv2DNode("conv3_1"),
                     tn.ReLUNode("relu3_1"),
                     tl.Conv2DNode("conv3_2"),
                     tn.ReLUNode("relu3_2"),
                     tl.Conv2DNode("conv3_3"),
                     tn.ReLUNode("relu3_3")]),
                 num_filters=256),
             ...
             tn.HyperparameterNode(
                ...
                tn.SequentialNode(
                    "conv_group_4_seq",
                    [tl.Conv2DNode("conv4_1"),
                     tn.ReLUNode("relu4_1"),
                     tl.Conv2DNode("conv4_2"),
                     tn.ReLUNode("relu4_2"),
                     tl.Conv2DNode("conv4_3"),
                     tn.ReLUNode("relu4_3")]),
                 num_filters=512),
             ...
             tn.HyperparameterNode(
                ...
                tn.SequentialNode(
                    "conv_group_5_seq",
                    [tl.Conv2DNode("conv5_1"),
                     tn.ReLUNode("relu5_1"),
                     tl.Conv2DNode("conv5_2"),
                     tn.ReLUNode("relu5_2"),
                     tl.Conv2DNode("conv5_3"),
                     tn.ReLUNode("relu5_3")]),
                 num_filters=512),
