...
from treeano.sandbox.nodes import bachelor_normalization as bn
...
model = tn.HyperparameterNode(
    ...
    tn.SequentialNode(
        ...
        [tn.InputNode("x", shape=(None, 28 * 28)),
         tn.DenseNode("fc1"),
         bn.BachelorNormalizationNode("bn1"),
         tn.ReLUNode("relu1"),
         # tn.DropoutNode("do2", p=0.5),
         tn.DenseNode("fc2"),
         bn.BachelorNormalizationNode("bn2"),
         tn.ReLUNode("relu2"),
         # tn.DropoutNode("do3", p=0.5),
         tn.DenseNode("fc3", num_units=10),
         bn.BachelorNormalizationNode("bn3"),
         tn.SoftmaxNode("pred"),
         ]),
    num_units=512,
...
train_fn = canopy.handled_fn(
    ...
    [canopy.handlers.time_call(key="total_time"),
     # HACK need to rebuild network for bachelor_normalization
     # updates to be set
     canopy.handlers.override_hyperparameters(deterministic=False),
