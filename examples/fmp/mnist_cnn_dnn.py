...
model = tn.HyperparameterNode(
    ...
    tn.SequentialNode(
        ...
        [tn.InputNode("x", shape=(None, 1, 28, 28)),
         ...
         tn.ReLUNode("relu1"),
         fmp.DisjointPseudorandomFractionalMaxPool2DNode("fmp1"),
         tn.DnnConv2DWithBiasNode("conv2"),
         tn.ReLUNode("relu2"),
         fmp.DisjointPseudorandomFractionalMaxPool2DNode("fmp2"),
         tn.DnnConv2DWithBiasNode("conv3"),
         tn.ReLUNode("relu3"),
         fmp.DisjointPseudorandomFractionalMaxPool2DNode("fmp3"),
         tn.DnnConv2DWithBiasNode("conv4"),
         tn.ReLUNode("relu4"),
         fmp.DisjointPseudorandomFractionalMaxPool2DNode("fmp4"),
         tn.DenseNode("fc1"),
         tn.ReLUNode("fc_relu"),
         tn.DropoutNode("do1"),
