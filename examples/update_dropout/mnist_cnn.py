...
from treeano.sandbox.nodes import update_dropout
import canopy
...
with_update_dropout = update_dropout.MomentumUpdateDropoutNode(
    "update_dropout",
    model,
    update_dropout_probability=0.8,
    update_dropout_momentum=0.9,
    rescale_updates=True
)
